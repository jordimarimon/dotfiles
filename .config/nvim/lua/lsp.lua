...
vim.api.nvim_create_autocmd("LspAttach", {
    ...
    callback = function(args)
        ...
        if client.name == "ts_ls" then
            ...
            vim.api.nvim_buf_create_user_command(buf, "RenameFile", function()
            ...
            vim.api.nvim_buf_create_user_command(buf, "RemoveUnusedImports", function()
            ...
            vim.api.nvim_buf_create_user_command(buf, "AddMissingImports", function()
                vim.lsp.buf.code_action({
                    apply = true,
                    context = {
                        diagnostics = {},
