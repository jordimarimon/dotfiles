...
vim.keymap.set(
    ...
    "<leader>d",
    '"_d',
    { desc = "Deletes to black hole register", silent = true }
)
vim.keymap.set(
    { "n", "v" },
    "<leader>x",
...
vim.keymap.set(
    ...
    "<leader>c",
    '"_c',
    { desc = "Changes to black hole register", silent = true }
)
vim.keymap.set(
    { "n", "v" },
    "<leader>p",
...
vim.keymap.set(
    ...
    "<C-j>",
    "<C-w><C-j>",
    { desc = "Move focus to the lower window", silent = true }
)
vim.keymap.set(
    "n",
    "<C-k>",
    "<C-w><C-k>",
    { desc = "Move focus to the upper window", silent = true }
)
...
vim.api.nvim_set_keymap(
    ...
    "<M-S-l>",
    ":+tabmove<CR>",
    { silent = true, noremap = true, desc = "[T]ab [M]ove [N]ext" }
)
...
vim.keymap.set(
    ...
    "gb",
    ":ls<CR>:b<Space>",
    { noremap = true, silent = true, desc = "Search in loaded buffers" }
)
